...
const AboutSection = () => {
  ...
  return (
    <div className=' flex justify-around mx-auto  items-center w-full min-h-screen flex-col'>
    <div className="container flex justify-center mx-auto items-center h-screen">
      <div className='flex items-center max-tablet:flex-col-reverse max-mobile:flex-col-reverse gap-9'>
        <Image classname="size-80 max-laptop:size-1/3 mx-3 rounded-md max-mobile:size-2/3" image={AboutImg} alt="Image" />
